...
class PlaystationAdapter(private val context: Context,
                         private var gamesList: MutableList<Playstation>)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PlaystationViewHolder {
        ...
        return PlaystationViewHolder(view)
    }
    ...
    fun setFilter(gamesList: ArrayList<Playstation>) {
    ...
    inner class PlaystationViewHolder(view: View) : RecyclerView.ViewHolder(view) {
