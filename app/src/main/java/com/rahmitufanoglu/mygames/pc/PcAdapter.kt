...
class PcAdapter(private val context: Context,
                private var gamesList: MutableList<Pc>)
    ...
    fun setFilter(gamesList: ArrayList<Pc>) {
    ...
    inner class PcViewHolder(view: View) : RecyclerView.ViewHolder(view) {
