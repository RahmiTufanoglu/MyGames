...
class XboxAdapter(private val context: Context,
                  private var gamesList: MutableList<Xbox>)
    : RecyclerView.Adapter<XboxAdapter.XboxViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): XboxViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.list_item_games, parent, false)
        return XboxViewHolder(view)
    }

    @SuppressLint("InflateParams")
    override fun onBindViewHolder(holder: XboxViewHolder, position: Int) {
    ...
    fun setFilter(gamesList: ArrayList<Xbox>) {
    ...
    inner class XboxViewHolder(view: View) : RecyclerView.ViewHolder(view) {
